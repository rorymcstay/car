...
driver = WebDriver()
driver.get("https://www.pistonheads.com/classifieds/used-cars/other-makes/all-models/corvette-stingray-c7-red-edition-automatic/9472888")

source = HTMLtoJSONParser.to_json(driver.page_source)
